...
public class Employee {
	...
	public static void main(String[] args) {
		...
		List<Employee> sorted = list.stream()
				.sorted(Comparator.comparing(Employee::getName) // Sort by name (ascending)
						.thenComparing(Comparator.comparing(Employee::getSalary).reversed())) // Sort salary (descending)
