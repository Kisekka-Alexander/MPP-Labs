...
public class Main {
    public static void main(String[] args) {
        ...
        PayCheck hourlyPaycheck = hourly.calcCompesation(1, 2025);
        System.out.println("Hourly Employee:");
        hourlyPaycheck.print();

        // Salaried Employee
        Employee salaried = new Salaried("E002", 3000.0);
        PayCheck salariedPaycheck= salaried.calcCompesation(1, 2025);
        System.out.println("\nSalaried Employee:");
        ...
        PayCheck commissionedPaycheck = commissioned.calcCompesation(1, 2025);
        System.out.println("\nCommissioned Employee:");
